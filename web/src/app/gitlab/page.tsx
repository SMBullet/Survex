      ...
      <main className="min-h-screen bg-background bg-dots">
        <div className="mx-auto max-w-3xl px-6 py-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">GitLab Exposure Scan</h1>
          ...
          {/* Coming soon banner */}
          <div className="rounded-xl border border-orange-500/20 bg-card p-6 flex flex-col items-center text-center space-y-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5 space-y-4">
            <p className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest">Planned Features</p>
          ...
          <div className="rounded-xl border border-border bg-card p-5 space-y-3">
            <p className="text-sm font-medium text-foreground">Looking for code exposure scanning now?</p>
            <p className="text-sm text-muted-foreground">
