      ...
      <main className="min-h-screen bg-background bg-dots">
        <div className="mx-auto max-w-3xl px-6 py-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">GCP Asset Discovery</h1>
              <p className="text-sm text-muted-foreground">Google Cloud Platform enumeration and exposure detection</p>
            </div>
          </div>

          <div className="rounded-xl border border-violet-500/20 bg-card p-8 text-center space-y-4">
