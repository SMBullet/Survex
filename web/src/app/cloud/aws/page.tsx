      ...
      <main className="min-h-screen bg-[#0d0018] bg-dots">
        <div className="mx-auto max-w-3xl px-6 py-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">AWS Asset Discovery</h1>
              <p className="text-sm text-zinc-500">Amazon Web Services enumeration and exposure detection</p>
            </div>
          </div>

          <div className="rounded-xl border border-orange-500/20 bg-[#160025]/70 p-8 text-center space-y-4">
